...
![https://www.bmj.com/content/348/bmj.f7450](fig/Articulo_cap2_2.png){width="600" height="550"} Nota que el valor el RR y OR solo coinciden cuando la prevalencia es baja (P0=0.1, linea azul)
