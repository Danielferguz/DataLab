...
tabla_preguntas <- data.frame(
  Tipo_de_Pregunta = c("📌 Estudios de Prevalencia <br>Incidencia", "📌 Estudios de Intervención", "📌 Estudios observacionales analíticos", "📌 Estudios de Pronóstico", "📌 Estudios de Pruebas Diagnósticas"),
  Acronimo = c(
...
datatable(tabla_preguntas, 
  ...
  formatStyle(
    ...
    fontSize = '11px' # Reducir tamaño de letra a 12px
  )
```
...
*Título del estudio:*
"Experiencias y desafíos de los pacientes con diabetes tipo 2 en la adopción de cambios en su estilo de vida"

*Objetivo:*
Explorar las percepciones y barreras que enfrentan los pacientes con diabetes tipo 2 al modificar su alimentación y hábitos de ejercicio.

*Metodología:*
Se realizaron entrevistas semiestructuradas con 20 pacientes diagnosticados con diabetes tipo 2 en los últimos 5 años.
Se utilizó un análisis temático para identificar los principales factores que influyen en su adherencia a las recomendaciones médicas.

*Hallazgos:*
Factores motivadores: Deseo de mejorar la salud, apoyo familiar.
Barreras identificadas: Falta de información clara, costos de una dieta saludable, dificultades emocionales.

*Conclusión:*
Se necesita un enfoque más personalizado en la educación sobre diabetes, considerando los desafíos individuales de los pacientes.
...
tabla_spider <- data.frame(
  Componente = c("S - Sample", "P - Phenomenon of Interest", "D - Design", "E - Evaluation", "R - Research Type"),
  Descripción = c(
