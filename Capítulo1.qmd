...
::: {margin-note}
Esta es una nota al margen que aparecerá en la derecha en la exportación a HTML.
:::


Este es un ejemplo de texto con una referencia en el margen.  
::: {marginfigure}
![Referencia importante](logo.png)
Referencia tomada de *Nombre del Autor (Año)*.
:::
